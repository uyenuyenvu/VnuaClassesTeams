# VnuaSchedule - Microsoft Teams App
...
2. mở terminal trong project run:
	npm install yo gulp-cli
	npm install generator-teams
	npx yo teams

(
 What kind of Tab would you like to create? Personal (static)
[tab] Do you require Azure AD Single-Sign-On support for the tab? No

)
	npx gulp ngrok-serve
3. lấy url có đuôi .ngrok.io
	truy cập https://url
4. đăng ký/ đăng nhập ngrok
	uyenvt.vnua@gmail.com
	dse.vnua.edu.vn
5. vào install your authen
	run: npx + link
VD: npx ngrok authtoken 27TTDD027fo5syRAgM5o1Nw0Zxv_2tUqY6kcBKto7ZF7GKnNs
6. tắt npx gulp ngrok-serve đi 
thay PUBLIC_HOSTNAME ở env bằng domain của ngrok
	vd: PUBLIC_HOSTNAME=427e-2402-800-61b1-3082-d171-b555-d68a-ab90.ngrok.io/
7. run ở terminal 
	7.1 npx gulp manifest
	7.2 npx gulp build
	7.3 npx gulp serve

8. lên msteam-> ... -> more apps->manage your apps-> upload a custom app
	chọn file zip trong dự án->package
